...
const uint8_t FONT_ARRAY_SIZE = 96;
...
const uint8_t FontArray[FONT_ARRAY_SIZE][FONT_CHAR_MAX_WIDTH] =
	...
	{0x08, 0x36, 0x41, 0xff, 0xff},		//'{'
	{0x7f, 0xff, 0xff, 0xff, 0xff},		//'|'
	{0x41, 0x36, 0x08, 0xff, 0xff},		//'}'
	{0x04, 0x02, 0x0c, 0x10, 0x08},		//'~'
	{0x06, 0x09, 0x09, 0x06, 0xff}		//'°' - should be at ASCII 248
	};
